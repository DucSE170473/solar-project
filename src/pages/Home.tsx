...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      {/* 2. TRUST BAR: Các con số biết nói & Chứng nhận */}
      <section className="bg-blue-900 py-10 text-white">
        <div className="max-w-7xl mx-auto px-6 flex flex-wrap justify-around gap-8 text-center">
          <div className="space-y-1">
            ...
            <p className="text-xs font-bold uppercase tracking-widest opacity-70">An toàn lao động</p>
          </div>
          <div className="space-y-1">
            <p className="text-3xl font-black text-amber-400">98%</p>
            <p className="text-xs font-bold uppercase tracking-widest opacity-70">Đúng tiến độ</p>
          </div>
          <div className="space-y-1">
            <p className="text-3xl font-black text-amber-400">ISO 9001</p>
            <p className="text-xs font-bold uppercase tracking-widest opacity-70">Tiêu chuẩn chất lượng</p>
          </div>
          <div className="space-y-1">
            <p className="text-3xl font-black text-amber-400">24/7</p>
            <p className="text-xs font-bold uppercase tracking-widest opacity-70">Hỗ trợ kỹ thuật</p>
          </div>
        </div>
      </section>

      {/* 3. ABOUT SECTION: Giới thiệu năng lực TTB-Corp/Thanh Cong Group */}
      <About />

      {/* 4. SERVICES HIGHLIGHT: Tập trung vào Kết cấu thép & PCCC */}
      <div className="bg-slate-50">
        <Services />
      </div>

      {/* 5. WHY CHOOSE US: Tại sao khách hàng chọn bạn? */}
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
             ...
             <img 
               ...
               className="rounded-3xl shadow-2xl border-b-8 border-blue-900"
             />
          </div>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex gap-4">
                  <div className="mt-1"><CheckCircle2 className="text-blue-600" size={24} /></div>
                  <div>
      ...
      {/* 6. PROJECT GRID: Minh chứng thực tế */}
      <div className="border-t border-slate-100">
        <Projects />
      </div>

      {/* 7. TESTIMONIALS (Optional): Ý kiến khách hàng */}
      <section className="py-20 bg-blue-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="flex justify-center gap-1 mb-6 text-amber-500">
                {[1,2,3,4,5].map(i => <Star key={i} fill="currentColor" size={20} />)}
            </div>
            <p className="text-2xl font-medium italic text-slate-700 leading-relaxed">
